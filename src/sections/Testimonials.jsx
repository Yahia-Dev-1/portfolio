...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 sm:py-24 relative overflow-hidden">
      <div
      ...
      >
        ...
        mx-auto mb-10 sm:mb-12 scroll-reveal"
        >
          <span
          ...
          font-bold mt-4 mb-6 text-secondary-foreground scroll-reveal"
          >
            Kind words from{" "}
            <span
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Main Testimonial */}
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200 scroll-reveal-scale">
